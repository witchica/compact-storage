...
import com.workshop.compactchests.network.ChestHandler;
import com.workshop.compactchests.network.ChestPacket;
...
{
    @SidedProxy(serverSide = "com.workshop.compactchests.proxy.Server", clientSide = "com.workshop.compactchests.proxy.Client", modId = ChestReferences.ID)
