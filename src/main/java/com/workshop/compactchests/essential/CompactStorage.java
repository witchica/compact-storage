package com.workshop.compactchests.essential;

import com.workshop.compactchests.essential.init.StorageBlocks;
import com.workshop.compactchests.essential.init.StorageInfo;
import com.workshop.compactchests.essential.init.StorageItems;
import com.workshop.compactchests.essential.proxy.IProxy;
...
public class CompactStorage
{
    ...
    public void preInit(FMLPreInitializationEvent event)
    {
        ...
        {
            case CLIENT: legacy_instance.proxy = new com.workshop.compactchests.legacy.proxy.Client(); break;
            case SERVER: legacy_instance.proxy = new com.workshop.compactchests.legacy.proxy.Server(); break;
        }
    }
