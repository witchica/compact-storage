...
public class CompactStorage {
	...
	public static void registerBlocks(RegistryEvent.Register<Block> e) {
		e.getRegistry().registerAll(ModBlocks.chest = new BlockChest(), ModBlocks.chestBuilder = new BlockChestBuilder(), ModBlocks.barrel = new BlockBarrel(), ModBlocks.barrel_fluid = new BlockFluidBarrel());
